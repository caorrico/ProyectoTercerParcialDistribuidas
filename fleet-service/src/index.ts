...
const startServer = async () => {
  ...
  app.listen(PORT, () => {
    console.log(`\n🚀 Fleet Service corriendo en http://localhost:${PORT}`);
    console.log(`📊 GraphQL Playground: http://localhost:${PORT}/graphql`);
    console.log(`🔗 REST API Fleet: http://localhost:${PORT}/api/fleet`);
    console.log(`🔗 REST API Tracking: http://localhost:${PORT}/api/tracking`);
